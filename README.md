...
│                                                                      │
│  1. Scan queued drops from drops.json                                │
│  2. For each drop:                                                   │
│     • discover() on-chain if mintTime unknown                        │
...
└─────────────────────────────┬────────────────────────────────────────┘
   ...
   │    WAIT     │    │     LOG     │    │       _fireDrop()        │
   │             │    │             │    │                          │
   │ • idle      │    │ • approaching│   │ 1. Status → monitoring   │
   │ • next tick │    │   T-0       │    │ 2. Re-discover chain     │
   │             │    │ • prep gas  │    │ 3. Balance check         │
   └─────────────┘    └─────────────┘    │ 4. Promise.all fire      │
                                         │ 5. Save results          │
                                         └────────────┬─────────────┘
                                                      │
